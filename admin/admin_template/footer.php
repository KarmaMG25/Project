...
<footer class="footer mt-auto py-3">
  ...
  <small class="d-block" style="color: #000; font-weight: 500;">&copy; <?php echo date("Y"); ?> Angus & Coote. All rights reserved.</small>
    ...
    <a href="#"><img src="/Project_7/include/facebook.png" alt="Facebook" style="width: 28px;"></a>
    <a href="#"><img src="/Project_7/include/instagram.png" alt="Instagram" style="width: 28px;"></a>
    <a href="#"><img src="/Project_7/include/X.png" alt="Twitter" style="width: 28px;"></a>
